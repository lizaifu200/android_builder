var rule = {
    ...
    class_name: '🎞️影视🎞️4k电影&🎞️影视🎞️4k电视剧&🎞️影视🎞️4k综艺&🎞️影视🎞️4k动漫&🎞️影视🎞️4k少儿&🎞️影视🎞️4k纪录片',
 ...
 lazy: $js.toString(() => {
    ...
    // 发起请求并解析返回的 JSON 数据
    let response = JSON.parse(request("http://yunhai.qijiyun.vip/home/api?type=ys&uid=312821&key=abfgjnwxEGJTVXZ569&url=" + input));
    ...
    二级: $js.toString(() => {
        ...
        VOD.vod_play_from = yg.length < 1 ? "🎞️影视🎞️4k-原画60帧" : "🎞️影视🎞️4k-原画60帧$$$ 预告及花絮";
